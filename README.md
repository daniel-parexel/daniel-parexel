...
- 📈 I have expertise in stochastic processes (Markov models, survival analysis), Bayesian inference, surrogate outcomes analysis, meta-analysis, external and augmented control arms, and machine learning (e.g., Bayesian networks)
